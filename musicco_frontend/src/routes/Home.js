  ...
  return (
    <div className="h-full w-full flex">
      ...
      <div className="h-full w-4/5 bg-app-black overflow-auto">
        <div className="navbar w-full h-1/6 bg-black bg-opacity-30 flex items-center justify-end">
          <div className="w-1/2 flex h-full">
            ...
            <div className="w-2/5 flex justify-around h-full items-center">
              ...
              <div className="bg-white h-2/5 px-9 flex items-center justify-center rounded-full font-semibold cursor-pointer">
                Log in
              </div>
            </div>
          </div>
