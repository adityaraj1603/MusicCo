      ...
      <div className="h-full w-4/5 bg-app-black overflow-auto">
        <div className="navbar w-full h-1/10 bg-black bg-opacity-30 flex items-center justify-end">
          <div className="w-1/2 flex h-full">
            ...
            <div className="w-1/10 flex justify-around h-full items-center">
              <IconText
                // iconName={"material-symbols:home"}
                displayText={"SignUp"}
                targetLink={"/signup"}
            ...
            {/* <div className="bg-white h-2/3 px-2 flex items-center justify-center rounded-full font-semibold cursor-pointer"> */}
            <div className="w-3/10 flex justify-around h-full items-center">
              <IconText
                // iconName={"material-symbols:home"}
                displayText={"Log in"}
                targetLink={"/login"}
