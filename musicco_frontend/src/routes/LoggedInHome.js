...
const Home = () => {
  return (
    <div className="h-full w-full flex">
      ...
      <div className="h-full w-4/5 space-x-3 bg-app-black overflow-auto">
        <div className="navbar w-full h-1/10 space-x-3 bg-black bg-opacity-30 flex items-center justify-end">
          <div className="w-1/2 p-6 flex h-full space-x-3 overflow-auto">
            <div className="w-2/3 h-10 space-x-3 flex justify-around items-center">
              <TextWithHover displayText={"Premium"} />
              <TextWithHover displayText={"Support"} />
              <TextWithHover displayText={"Download"} />
              <div className="h-1/2  border-r border-white"></div>
            </div>
            <div className="w-1/3 space-x-3 flex justify-around h-full items-center">
              <TextWithHover displayText={"Upload Song"} />
              <div className="bg-white px-1 w-10 h-10 flex items-center justify-center rounded-full font-semibold cursor-pointer">
                AS
              </div>
            </div>
          </div>
