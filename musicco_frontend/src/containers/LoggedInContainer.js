          ...
          <div className="navbar w-full h-1/10 bg-black bg-opacity-30 flex items-center justify-end">
            <div className="w-3/5 flex h-full">
              ...
              <div className="w-1/2 flex justify-around h-full items-center">
                ...
                <div className="bg-white w-10 h-7 flex items-center justify-center  font-semibold cursor-pointer">
                  <button
                    className="bg-red-400 font-semibold p-1/2 px-5 rounded-full"
                    onClick={(e) => {
                      e.preventDefault();
                      logout();
                    }}
